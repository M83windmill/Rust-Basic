...
fn build_scores_table(results: String) -> HashMap<String, Team> {
    ...
    for r in results.lines() {
        ...
        .and_modify(|team1|{team1.goals_scored+=team_1_score;team1.goals_conceded+=team_2_score})
        .or_insert(Team{goals_scored:team_1_score,goals_conceded:team_2_score});
        scores.entry(team_2_name)
        .and_modify(|team2|{team2.goals_scored+=team_2_score;team2.goals_conceded+=team_1_score})
